...
@AllArgsConstructor
//회원 엔티티 클래스
<<<<<<< HEAD:src/main/java/com/example/lietenerbox/model/Person.java
@Table(name = "person")
public class Person {
=======
@Table(name="member")
public class Member {
>>>>>>> parent of 8c5201d... Member엔티티명 Person으로 변경:src/main/java/com/example/lietenerbox/model/Member.java
    @Id
