...
!function (a, b) {
    ...
    function Za(a, b, c) {
        ...
        for (d in b) if (e = b[d], Ua.exec(e)) {
            if (delete b[d], f = f || "toggle" === e, e === (p ? "hide" : "templates.qna.show")) {
                if ("templates.qna.show" !== e || !q || void 0 === q[d]) continue;
                p = !0
            }
    ...
    }), n.each(["toggle", "templates.qna.show", "hide"], function (a, b) {
        var c = n.fn[b];
        n.fn[b] = function (a, d, e) {
            return null == a || "boolean" == typeof a ? c.apply(this, arguments) : this.animate(Xa(b, !0), a, d, e)
        }
    }), n.each({
        slideDown: Xa("templates.qna.show"),
        slideUp: Xa("hide"),
        slideToggle: Xa("toggle"),
        fadeIn: {opacity: "templates.qna.show"},
