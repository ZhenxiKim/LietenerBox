...
+function (a) {
    ...
    function b(b) {
        return this.each(function () {
            var d = a(this), e = d.data("bs.collapse"),
                f = a.extend({}, c.DEFAULTS, d.data(), "object" == typeof b && b);
            !e && f.toggle && "templates.qna.show" == b && (b = !b), e || d.data("bs.collapse", e = new c(this, f)), "string" == typeof b && e[b]()
        })
    }
    ...
    c.VERSION = "3.2.0", c.DEFAULTS = {toggle: !0}, c.prototype.dimension = function () {
        ...
        if (!this.transitioning && !this.$element.hasClass("in")) {
            var c = a.Event("templates.qna.show.bs.collapse");
        ...
        this[this.$element.hasClass("in") ? "hide" : "templates.qna.show"]()
    };
    var d = a.fn.collapse;
    ...
    g.VERSION = "3.2.0", g.prototype.toggle = function (d) {
        ...
        if (!e.is(".disabled, :disabled")) {
            ...
            if (b(), !g) {
                ...
                if (f.trigger(d = a.Event("templates.qna.show.bs.dropdown", h)), d.isDefaultPrevented()) return;
    ...
    c.VERSION = "3.2.0", c.DEFAULTS = {backdrop: !0, keyboard: !0, show: !0}, c.prototype.toggle = function (a) {
        ...
        var c = this, d = a.Event("templates.qna.show.bs.modal", {relatedTarget: b});
    ...
    a.fn.modal = b, a.fn.modal.Constructor = c, a.fn.modal.noConflict = function () {
        ...
        d.is("a") && c.preventDefault(), f.one("templates.qna.show.bs.modal", function (a) {
    ...
    c.VERSION = "3.2.0", c.DEFAULTS = {
        ...
        var b = a.Event("templates.qna.show.bs." + this.type);
    ...
    c.VERSION = "3.2.0", c.prototype.show = function () {
        ...
        if (d || (d = b.attr("href"), d = d && d.replace(/.*(?=#[^\s]*$)/, "")), !b.parent("li").hasClass("active")) {
            var e = c.find(".active:last a")[0], f = a.Event("templates.qna.show.bs.tab", {relatedTarget: e});
    ...
    a.fn.tab = b, a.fn.tab.Constructor = c, a.fn.tab.noConflict = function () {
        ...
        c.preventDefault(), b.call(a(this), "templates.qna.show")
    })
}(jQuery), +function (a) {
    "use strict";
